 ...
 *
 * Commandline:
 *    --api='glx=1.4' --extensions='GLX_MESA_query_renderer,GLX_SGI_swap_control' c
 *
 * Online:
 *    http://glad.sh/#api=glx%3D1.4&extensions=GLX_MESA_query_renderer%2CGLX_SGI_swap_control&generator=c&options=
 *
 */
